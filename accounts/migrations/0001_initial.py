...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('badge_type', models.CharField(choices=[('first_chore', '🌟 First Chore'), ('streak_3', '🔥 3-Day Streak'), ('streak_7', '⚡ 7-Day Streak'), ('points_100', '💯 100 Points'), ('points_500', '🏆 500 Points'), ('points_1000', '👑 1000 Points'), ('perfect_week', '🎯 Perfect Week'), ('helper', '🤝 Super Helper'), ('early_bird', '🌅 Early Bird'), ('champion', '🥇 Champion')], max_length=50)),
